...
export function RecordDetailsDialog({ open, title, description, details = [], actions, footerActions, children, hideDetailsList = false, onClose }: RecordDetailsDialogProps) {
  return (
